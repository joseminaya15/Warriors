                    ...
                    <div role="tabpanel" class="tab-pane fade" id="recomendaciones">
                        <div class="js-information p-20">
                            ...
                            <ul class="p-l-15">
                                ...
                                <li>No está permitido ingresar comidas y bebidas al campus</li>
                                <li>No está permitido tomar fotos o videos dentro del campus fuera del área de conferencias.</li>
                                <li>Mantener una conducta y lenguaje apropiado</li>
                            </ul>
