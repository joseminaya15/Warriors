...
<body>
    ...
    <section id="partners" class="js-section">
        <div class="js-container">
    ...
    <section id="agenda" class="js-section js-white">
        <div class="js-container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#agosto7" aria-controls="agosto7" role="tab" data-toggle="tab">MAR, 07 AGOSTO</a></li>
                <li><a href="#agosto8" aria-controls="agosto8" role="tab" data-toggle="tab">MIE, 08 AGOSTO</a></li>
                <li><a href="#agosto9" aria-controls="agosto9" role="tab" data-toggle="tab">JUE, 09 AGOSTO</a></li>
            </ul>
    ...
    <section id="logistic" class="js-section">
        <div class="js-container">
            <h2 class="js-title">LOGISTICA</h2>
            <ul class="nav nav-tabs" role="tablist">
                ...
                <div role="tabpanel" class="tab-pane fade" id="evento">
                    <div class="js-information">
                        ...
                        <ul>
                            ...
                            <li>Directorio de asistentes</li>
                            <li>Encuesta final del evento</li>
                        </ul>
                    </div>
                </div>
